...
public class SSLSocketFactoryRightUtils {
    static int keyServerStroreID = R.raw.tomcat;
    ...
    public static SSLSocketFactory createSSLSocketFactory(Context context) {
        ...
        try {
            ...
            BLog.e("  createSSLSocketFactory    " + e.getLocalizedMessage());
            e.printStackTrace();
        }
    ...
    public static TrustManager[] getTurstManager(InputStream... certificates) {
        try {
            ...
            BLog.e("     KeyStore.getDefaultType() = " + KeyStore.getDefaultType());
            ...
            BLog.e("keyStore.getType()=" + keyStore.getType());
            return trustManagerFactory.getTrustManagers();

        } catch (Exception e) {
            e.printStackTrace();
            BLog.e("  getTurstManager " + e.getLocalizedMessage());
        }
        BLog.e(" getTurstAllManager  ");
